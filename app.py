...
app.layout = html.Div(
    [
            ...
            dbc.Row(
                    ...
                    dbc.Col(
                            ...
                            dbc.Row(
                                    ...
                                    html.P("Proyecto que presenta información sobre la evolución de casos de Dengue en Argentina",
                                    className="lead",
                                            ),
        ...
        dbc.Jumbotron(
            ...
            dbc.Row(
                    [
                    dbc.Col([html.H1("Dengue en Argentina"),
                    ...
                    dbc.Col([html.H2("Dengue en Argentina - Casos por Provincia"),
                             html.P("Indicadores presentados: total de casos notificados, total de casos autóctonos confirmados, Incidencia Acumulada (casos confirmados cada 100.000 habitantes), cantidad de casos en investigación y fallecimientos por dengue confirmado. "),
                            ]
                            ),
                            dcc.Tabs(id="tabsProvincias",
                                    value="tab-1",
        ...
        dbc.Jumbotron(
            ...
            children=[
                        ...
                        html.P("Analisis realizado con datos obtenidos de la Organización Panamericana de la Salud",
                                className="lead",
                                ),
                        html.Hr(className="my-2"),
                        html.P("En lo que va del año 2020 ya se han superado la cantidad total de casos reportados en el año 2016 (41.724) que fue el año con mayor número de casos. En el gráfico se puede ver la evolución comparada con años anteriores.",
                                className="lead",
                                ),
                    ],
                    ),
...
def render_content(tab):
    if tab == "tab-1":
        figProvinciasAutoctonos = px.line(casosDengueInvertido,x="FechaReporte",y="Autoctonos",color="Provincia",height=650)
                                    .update_layout(xaxis_title="Fecha de Reporte", yaxis_title="Casos autóctonos confirmados", legend={'traceorder':'normal'})
        return html.Div(
                        [
                        dbc.Col(
                                [
        ...
        figProvinciasIA = px.line(casosDengueInvertido, x="FechaReporte", y="IA", color="Provincia", height=650)
                            .update_layout(xaxis_title="Fecha de Reporte", yaxis_title="Incidencia Acumulada", legend={'traceorder':'normal'})
        return html.Div(
                        [
                        dbc.Col(
                                [
                                html.H4("Incidencia Acumulada de casos autoctónos confirmados"),
                                tml.P("Incidencia Acumulada (IA) = (cantidad de casos/población)*100.000",className="lead"),
                                ]
                                ),
                        dbc.Row(
                                [
        ...
        figProvinciasImportados = px.line(casosDengueInvertido,x="FechaReporte",y="Importados",color="Provincia",height=650)
                                    .update_layout(xaxis_title="Fecha de Reporte", yaxis_title="Casos importados confirmados", legend={'traceorder':'normal'})
        return html.Div(
                        [
                        dbc.Col(
                                [
        ...
        figProvinciasEnInv = px.bar(casosDengueInvertido,x="FechaReporte",y="Total en Inv",color="Provincia",height=650)
        ...
        figProvinciasNotificados = px.line(casosDengueInvertido,x="FechaReporte",y="Total notificados para dengue",color="Provincia",height=650)
        ...
        figProvinciasFallecidos = px.line(casosDengueInvertido,x="FechaReporte",y="AcumFallecidos",color="Provincia",height=650)
...
def render_content(tab):
    if tab == "tab-1":
        figRegionAutoctonos = px.line(dengueRegionesAut, x='FechaReporte',y='Autoctonos',color='Region')
                                .update_layout(xaxis={'tickformat': '%y/%m'},xaxis_title="Fecha de Reporte", yaxis_title="Casos autóctonos confirmados",  legend={'traceorder':'normal'})
        return html.Div(
                        [
                        dbc.Col(
                                [
        ...
        figRegionImportados = px.line(dengueRegionesImp, x='FechaReporte',y='Importados',color='Region')
                                .update_layout(xaxis={'tickformat': '%y/%m'},xaxis_title="Fecha de Reporte", yaxis_title="Casos importados confirmados", legend={'traceorder':'normal'})
        return html.Div(
                         [
                        dbc.Col(
                                [
...
def render_content(tab):
    if tab == "tab-1":
        figPaisAutoctonos = px.line(denguePaisAut, x="FechaReporte", y="Autoctonos", color="Pais")
                              .update_layout(xaxis_title="Fecha de Reporte", yaxis_title="Casos autóctonos confirmados", legend={'traceorder':'normal'})
        return html.Div(
                        [
                        dbc.Col(
        ...
        figPaisEnInv = px.bar(denguePaisInv, x="FechaReporte", y="Total en Inv", color="Pais")
                         .update_layout(xaxis_title="Fecha de Reporte", yaxis_title="Casos en investigación", legend={'traceorder':'normal'})
        return html.Div(
                        [
                        dbc.Col(
...
def render_content3(tab):
    if tab == "tab-1":
        figOPSConf = px.line(casosDenguePorAño,x="SE", y="Confirmados", color='Año')
                        .update_layout(xaxis_title="Semana Epidemiológica",yaxis_title="Casos confirmados")
        return html.Div(
                        [
                        dbc.Col(
                                [
                                html.H4("Total de casos Confirmados en Argentina entre los años 2014 y 2020"),
                                dbc.Row(
                                        [
                                        dbc.Col(html.H4(""), md=1),
        ...
        return html.Div(
                        ...
                        dbc.Col(
                                [
                                html.H4("Total de personas fallecidas en Argentina entre los años 2014 y 2020"),
                        dbc.Row(
                            [
                                dbc.Col(html.H4(""), md=1),
